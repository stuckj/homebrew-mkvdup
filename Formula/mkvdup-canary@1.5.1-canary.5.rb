...
# Homebrew formula for mkvdup-canary@1.5.1-canary.5 (pinned to v1.5.1-canary.5)
# This file is auto-generated by the release workflow.
# To install: brew tap stuckj/mkvdup && brew install mkvdup-canary@1.5.1-canary.5
#
# The canary version can be installed alongside the stable version.

class MkvdupCanaryAT151Canary5 < Formula
