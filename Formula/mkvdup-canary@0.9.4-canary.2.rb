...
# Homebrew formula for mkvdup-canary@0.9.4-canary.2 (pinned to v0.9.4-canary.2)
# This file is auto-generated by the release workflow.
# To install: brew tap stuckj/mkvdup && brew install mkvdup-canary@0.9.4-canary.2
#
# The canary version can be installed alongside the stable version.

class MkvdupCanaryAT094Canary2 < Formula
