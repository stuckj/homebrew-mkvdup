...
# Homebrew formula for mkvdup-canary@1.3.0-canary.3 (pinned to v1.3.0-canary.3)
# This file is auto-generated by the release workflow.
# To install: brew tap stuckj/mkvdup && brew install mkvdup-canary@1.3.0-canary.3
#
# The canary version can be installed alongside the stable version.

class MkvdupCanaryAT130Canary3 < Formula
