...
# Homebrew formula for mkvdup-canary@1.6.3-canary.1 (pinned to v1.6.3-canary.1)
# This file is auto-generated by the release workflow.
# To install: brew tap stuckj/mkvdup && brew install mkvdup-canary@1.6.3-canary.1
#
# The canary version can be installed alongside the stable version.

class MkvdupCanaryAT163Canary1 < Formula
