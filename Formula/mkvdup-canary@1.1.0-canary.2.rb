...
# Homebrew formula for mkvdup-canary@1.1.0-canary.2 (pinned to v1.1.0-canary.2)
# This file is auto-generated by the release workflow.
# To install: brew tap stuckj/mkvdup && brew install mkvdup-canary@1.1.0-canary.2
#
# The canary version can be installed alongside the stable version.

class MkvdupCanaryAT110Canary2 < Formula
